...
static p_dnode locatenodei(PDList list, long long index)
{
	// Code
	p_dnode runner = list->head->next;
...
extern void dcll_swap(PDList list, long long index1, long long index2)
{
	// Code
	p_dnode  node1 = locatenodei(list, index1);
	p_dnode  node2 = locatenodei(list, index2);
