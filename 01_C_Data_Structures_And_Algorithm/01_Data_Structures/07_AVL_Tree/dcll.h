...
typedef 	struct node_dcll*	p_node_dcll_t;
typedef 	struct node_dcll** 	pp_node_dcll_t;
...
typedef     p_node_dcll_t   p_list_t;    
typedef     pp_node_dcll_t  pp_list_t;    
...
{
	data_t	data;
	p_node_dcll_t 	pnext, pprev;
};
#define 	SIZE_node_dcll	(sizeof(node_dcll_t))

struct dummy
{
    size_t noOfnode_dclls;
    p_node_dcll_t list;
};
