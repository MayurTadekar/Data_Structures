...
extern 	ret_t 	list_insert_after(list_t list, data_t edata, data_t idata, ret_t (*p_equality_compare_proc)(data_t data1, data_t data2));
extern	ret_t 	list_insert_before(list_t list, data_t edata, data_t idata, ret_t (*p_equality_compare_proc)(data_t data1, data_t data2));
...
extern 	ret_t 	list_remove_after(list_t list, data_t edata, p_data_t pdata, ret_t (*p_equality_compare_proc)(data_t data1, data_t data2));
extern 	ret_t 	list_remove_before(list_t list, data_t edata, p_data_t pdata, ret_t (*p_equality_compare_proc)(data_t data1, data_t data2));
extern 	ret_t 	list_remove(list_t list, data_t edata, p_data_t pdata, ret_t (*p_equality_compare_proc)(data_t data1, data_t data2));

extern 	len_t 	list_length(list_t list);
extern 	ret_t 	list_contains(list_t list, data_t edata, ret_t (*p_equality_compare_proc)(data_t data1, data_t data2));
